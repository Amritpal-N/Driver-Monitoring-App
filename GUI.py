    ...
    def update(self, dt):
        ...
        if root.current == "Screen2":
            ...
            if isCameraOn:
                ...
                hogFaceD = dlib.get_frontal_face_detector() #The code for building the drowsy detection system is a modified version of the eye blink detection system found here: https://github.com/pathak-ashutosh/Eye-blink-detection
